...
from modules.audio_features import AudioFeatures
from modules.scoring import compute_score, _score_pauses, _score_speaking_rate
from modules.semantic_analysis import SemanticResult
...
def test_grade_labels_assigned_correctly():
    ...
    features = make_features(silence_ratio=0.15, pitch_std_hz=30.0)
    score = compute_score(semantic, features, word_count=70)
